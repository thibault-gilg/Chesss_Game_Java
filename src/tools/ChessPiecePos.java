...
public enum ChessPiecePos {
	...
	PIONBLANC("Pion", Couleur.BLANC, new Coord[] {new Coord(0,6), new Coord(1,6), new Coord(2,6), 
			new Coord(3,6), new Coord(4,6), new Coord(5,6), new Coord(6,6), new Coord(7,6)}),
	...
	PIONNOIR("Pion", Couleur.NOIR, new Coord[] {new Coord(0,1), new Coord(1,1), new Coord(2,1), 
			new Coord(3,1), new Coord(4,1), new Coord(5,1), new Coord(6,1), new Coord(7,1)})
	; 
	public String nom;
